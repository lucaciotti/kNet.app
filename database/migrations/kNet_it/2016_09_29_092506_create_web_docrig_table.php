...
class CreateWebDocrigTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection(env('DB_CNCT_IT', 'kNet_it'))->create('w_docrig', function (Blueprint $table) {
            $table->bigIncrements('id')->comment('ID Univoco per ogni Riga Doc');
    ...
    {
        Schema::connection(env('DB_CNCT_IT', 'kNet_it'))->drop('w_docrig');
    }
}
