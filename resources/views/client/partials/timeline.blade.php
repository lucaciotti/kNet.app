<ul class="timeline">
  ...
  @else
    <li class="time-label">
      <span class="bg-gray">
        <a href="{{ route('visit::insert', $codcli) }}"> {{ $dateNow->format('d M. Y') }} </a>
      </span>
    </li>
  @endif
  <li>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a type="button" class="btn btn-default" href="{{ route('visit::insert', $codcli) }}"><i class="fa fa-plus"> Inserisci Visita</i></a>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a type="button" class="btn btn-primary" href="">Visualizza TimeLine Completa</a>
  </li>
</ul>
